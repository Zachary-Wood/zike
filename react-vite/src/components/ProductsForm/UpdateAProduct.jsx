...
const UpdateAProduct = () => {
  ...
  useEffect(() => {
    if (singleProduct) {
        ...
        setSelectedSizes(singleProduct.size ? singleProduct.size.split(', ') : []);
        setClothing_type(singleProduct.clothing_type || "")
        setShowImage(singleProduct.product_image || "");
    }
  },[singleProduct])
  ...
  const handleSubmit = async (e) => {
        ...
        try {
          await dispatch(updateAProductThunk(productId, formData));
        } catch (error) {
