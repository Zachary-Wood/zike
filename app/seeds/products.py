...
def seed_products():
    ...
    products = [
        ...
        "type": "Running Shoe",
        "price": 160,
        "description": "Nike Air Max 270: Engineered for comfort and style, featuring a large Air Max unit for responsive cushioning. With a breathable mesh upper and lightweight construction, it blends modern aesthetics with exceptional performance.",
        "gender": 'Male',
        "size": "6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10.5, 11, 11.5, 12, 12.5, 13, 13.5, 14",
        "clothing_type": 'Shoes',
