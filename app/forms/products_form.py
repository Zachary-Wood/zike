...
class ProductForm(FlaskForm):
    ...
    gender = SelectField('Gender', choices=['Men\'s', 'Women\'s'], validators=[DataRequired()])
    size = SelectMultipleField('Choose your sizes', choices=[('6','6'),('6.5', '6.5'),('7','7'),('7.5', '7.5'),('8','8'),('8.5','8.5'),('9','9'),('9.5','9.5'),('10','10'),('10.5','10.5'),('11','11'),('11.5','11.5'),('12','12'),('12.5','12.5'),('13','13'),('14','14')], validators=[DataRequired()])
